...
module.exports = (...args) => mapArgumentsToObject(args, ({
    ...
    devServer: devServer || {
        ...
        proxy: proxy || {
            '/rest': {
                target: "https://reporting.nnb.isprambiente.it/mapstore",
                secure: false,
                headers: {
                    host: "reporting.nnb.isprambiente.it"
                }
            },
            '/pdf': {
                target: "https://reporting.nnb.isprambiente.it/mapstore",
            ...
            '/mapstore/pdf': {
                target: "https://reporting.nnb.isprambiente.it",
                secure: false,
                headers: {
                    host: "reporting.nnb.isprambiente.it"
                }
            ...
            '/proxy': {
                target: "http://51.15.160.236:9001/mapstore",
                secure: false,
                headers: {
                    host: "51.15.160.236:9001"
                }
            },
            '/docs': {
